...
#print ' '.join(filter(None, big_hero_6.storyline.split(' ')))
#exit()

frozen = media.Movie(
    "Frozen",
    "The story of a fearless princess who sets off on an epic journey \
    alongside a rugged iceman, his loyal pet reindeer, and a naive snowman \
    to find her estranged sister, whose icy powers have inadvertently trapped \
...
mulan = media.Movie(
    "Mulan",
    "To save her father from death in the army, a young maiden secretly goes \
...
rush_hours = media.Movie(
    "Rush Hours",
    "Two cops who are from different worlds and can't stand each other team \
    up to get back a kidnapped daughter.",
...
pitch_perfect = media.Movie(
    "Pitch Perfect",
    "The plot follows a college women's a cappella group, The Barden Bellas, \
    as they compete against another a cappella group from their college to \
    win Nationals.",
...
# add only those movie instances to be displayed in the browser to the movies list
