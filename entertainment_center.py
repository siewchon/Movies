...
frozen = media.Movie(
    ...
    "alongside a rugged iceman, his loyal pet reindeer, and a naive " \
    "snowman to find her estranged sister, whose icy powers have " \
...
mulan = media.Movie(
    "Mulan",
    "To save her father from death in the army, a young maiden secretly " \
    "goes in his place and becomes one of China's greatest heroines in the "\
    "process.",
